...
\item Hardware may support rendering APIs to varying degrees via feature sets and extensions, yet workarounds can be created and exposed as a common set of features. Additionally, features required by the standards are sometimes implemented to varying degrees, sometimes containing bugs. The wrapper allows these exceptional details to be caught in a single location.
...
\begin{figure}[h!]
  \centering
    ...
    \caption[SemanticSearchGraph]{SemanticSearchGraph}
...
\begin{figure}[h!]
  \centering
  \subfigure[AutoSemanticGraph1]{\label{fig:AutoSemanticGraph1}\digraph[width=0.7\linewidth]{AutoSemanticGraph1}{
    		"src" [
  ...
  \subfigure[AutoSemanticGraph2]{\label{fig:AutoSemanticGraph2}\digraph[width=0.9\linewidth]{AutoSemanticGraph2}{
    		"src" [
    			shape=rectangle style="rounded,filled"
    			label = <<table border="0" cellborder="0" cellspacing="8" >
    			<tr><td port="main" ><font point-size="14" >Source</font></td></tr>
  ...
  \caption[trololol]{trololol TODO}
