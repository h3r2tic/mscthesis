...
\begin{figure}
  \centering
  \subfigure[Lambertian]{\label{fig:Buddha_Lambert}\includegraphics[width=0.3\linewidth]{./BRDFs/Lambert.jpg}}
  \subfigure[Blinn-Phong]{\label{fig:Buddha_BlinnPhong}\includegraphics[width=0.3\linewidth]{./BRDFs/BlinnPhong_120.jpg}}
  \subfigure[Ashikhmin-Shirley]{\label{fig:Buddha_AS}\includegraphics[width=0.3\linewidth]{./BRDFs/AS_f9_r1.jpg}}
\subfigure[Cook-Torrance]{\label{fig:Buddha_CT}\includegraphics[width=0.3\linewidth]{./BRDFs/CookTorrance_f4_r9.jpg}}
\subfigure[ABC]{\label{fig:Buddha_ABC_area}\includegraphics[width=0.3\linewidth]{./BRDFs/ABC_area_approx_b100_c99.jpg}}
\subfigure[ABg]{\label{fig:Buddha_ABg}\includegraphics[width=0.3\linewidth]{./BRDFs/ABg_A06_B01_g19.jpg}}
